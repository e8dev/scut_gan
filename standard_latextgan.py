...
class Generator(Model):
  ...
  def __init__(self):
    """Initialize a Generator that generates fake text embeddings.
    """ 
...
class Discriminator(Model):
  ...
  def __init__(self):
    """Initialize a Discriminator that decides whether the input text embedding is fake or real 
    """ 
    ...
    #self.discriminator_layers = NoDependency({})
  ...
  def call(self, x): 
    ...
    Arguments:
      x (tensor): Real or fake text embedding 

    Returns:
      x (tensor): Recreated text embedding
    """
